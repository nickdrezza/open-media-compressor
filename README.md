...
- **Approach:** run compression entirely in the browser with FFmpeg WebAssembly for broad input support and the browser's JPEG encoder for common images.
...
- **Core**: `ffmpeg.wasm` for video and fallback image decoding, plus Canvas/JPEG for common images.
